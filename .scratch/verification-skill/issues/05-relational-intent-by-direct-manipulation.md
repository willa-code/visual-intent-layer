...
2026-09-18 — closed as `done`: all six boxes are ticked. The two undriven relation operators were driven, so the gap this comment names is gone. `.scratch/backlog.md` is retired; the parked list it carried now lives in `.scratch/backlog-triage/spec.md` under **Further Notes**.
