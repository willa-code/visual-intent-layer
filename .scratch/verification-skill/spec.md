...
2026-09-18 — both sentences above are superseded. `05` closed: it is `done`, and the Lever now drives all six relation families, so nothing is owed here. `.scratch/backlog.md` is retired, and the parked list it carried now lives in `.scratch/backlog-triage/spec.md` under **Further Notes**.
