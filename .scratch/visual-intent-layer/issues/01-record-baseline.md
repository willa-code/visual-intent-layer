# 01: Record the screenshot-and-chat baseline

**What to build:** Several real interface corrections performed the old way, with honest numbers captured before product enthusiasm can bias them.
...
- [ ] Failure modes where prose location descriptions misled the agent are written down with examples
- [ ] The baseline record is stored where ticket 17 can compare against it without relying on memory
